...
/** 재료 수정 요청 바디 */
export type UpdateIngredientRequest = Partial<Pick<CreateIngredientRequest, 'name' | 'quantity' | 'unit' | 'category' | 'expiryDate'>>;
//# sourceMappingURL=ingredient.types.d.ts.map